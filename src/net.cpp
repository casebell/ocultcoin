...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "OcultCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed.ocultcoin.org", "seed.ocultcoin.org"},
    {"seed1.ocultcoin.org", "seed1.ocultcoin.org"},
    {"seed2.ocultcoin.org", "seed2.ocultcoin.org"},
    {"seed3.ocultcoin.org", "seed3.ocultcoin.org"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("OcultCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("OcultCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("OcultCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("OcultCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. OcultCoin is probably already running."), addrBind.ToString().c_str());
        else
