...
// OcultCoin: total coins staked (non-spendable until maturity)
...
// OcultCoin: check 'spent' consistency between wallet and txindex
// OcultCoin: fix wallet spent state according to txindex
...
// OcultCoin: disable transaction (only for coinstake)
