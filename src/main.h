...
static const uint256 hashGenesisBlock("0x00000d88158febe61cfbf0cf086e008a1332e5a67cfe69f85757fd0d80b71bef");
static const uint256 hashGenesisBlockTestNet("0x000040414064a3b2adb3db241a4c79a13ef434368e98d65499e50f6a260ce0a9");
...
public:
    ...
    {
        // OcultCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // OcultCoin: get transaction coin age
...
public:
    ...
    // OcultCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // OcultCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // OcultCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // OcultCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // OcultCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // OcultCoin: block index flags
    enum  
    {
